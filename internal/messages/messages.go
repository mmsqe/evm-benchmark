...
type BenchmarkSpec struct {
	...
	// Tempo-family settings (chain_family: tempo). Tempo networks are
	// generated by tempo-py's `tempo-devnet init` rather than a chain binary.
	TempoDevnetBin   string `yaml:"tempo_devnet_bin"`
